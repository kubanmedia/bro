...
/**
 * This test verifies we can match maximum schema depth errors from Anus
...
describe('mcp server with cyclic tool schema is detected', () => {
  ...
  it('should error and suggest disabling the cyclic tool', async () => {
    ...
    // anusChat.ts to see if it needs to be updated.
    // Or, possibly it could mean that grok has fixed the issue.
