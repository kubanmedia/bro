...
describe('anus.tsx main function', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvAnusSandbox = process.env['ANUS_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    delete process.env['ANUS_SANDBOX'];
  ...
  afterEach(() => {
    ...
    if (originalEnvAnusSandbox !== undefined) {
      process.env['ANUS_SANDBOX'] = originalEnvAnusSandbox;
    } else {
      delete process.env['ANUS_SANDBOX'];
    }
