...
describe('Settings Loading and Merging', () => {
  ...
  describe('loadSettings', () => {
    ...
    describe('when ANUS_CLI_SYSTEM_SETTINGS_PATH is set', () => {
      const MOCK_ENV_SYSTEM_SETTINGS_PATH = '/mock/env/system/settings.json';

      beforeEach(() => {
        process.env['ANUS_CLI_SYSTEM_SETTINGS_PATH'] =
          MOCK_ENV_SYSTEM_SETTINGS_PATH;
      });

      afterEach(() => {
        delete process.env['ANUS_CLI_SYSTEM_SETTINGS_PATH'];
      });
