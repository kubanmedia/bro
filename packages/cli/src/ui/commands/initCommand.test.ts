...
describe('initCommand', () => {
  ...
  it('should inform the user if ANUS.md already exists', async () => {
  ...
  it('should create ANUS.md and submit a prompt if it does not exist', async () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(anusMdPath, '', 'utf8');
    ...
    expect(result.content).toContain(
      'You are ANUS, an AI agent that brings the power of Grok',
    );
  });
