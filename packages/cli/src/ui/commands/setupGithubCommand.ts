...
export const setupGithubCommand: SlashCommand = {
  ...
  action: async (
    ...
    const readmeUrl = `https://github.com/google-github-actions/run-anus-cli/blob/${releaseTag}/README.md#quick-start`;
    ...
    const workflows = [
      'anus-cli/anus-cli.yml',
      'issue-triage/anus-issue-automated-triage.yml',
      'issue-triage/anus-issue-scheduled-triage.yml',
      'pr-review/anus-pr-review.yml',
    ];
    ...
    for (const workflow of workflows) {
      downloads.push(
        (async () => {
          const endpoint = `https://raw.githubusercontent.com/google-github-actions/run-anus-cli/refs/tags/${releaseTag}/examples/workflows/${workflow}`;
    ...
    return {
      ...
      toolArgs: {
        description:
          'Setting up GitHub Actions to triage issues and review PRs with Anus.',
        command,
      },
    };
  },
