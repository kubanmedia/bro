...
export function KeypressProvider({
  ...
  useEffect(() => {
    ...
    if (usePassthrough) {
      ...
      // Also listen to 'keypress' directly on stdin for compatibility with tests/mocks
      ...
      stdin.on('keypress', handleKeypress);
      // Ensure the stream is flowing so 'keypress' events are emitted consistently in tests/CI
