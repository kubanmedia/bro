...
export interface HistoryItemBase {
  text?: string; // Text content for user/anus/info/error messages
}
...
export type HistoryItemAnus = HistoryItemBase & {
  type: 'anus';
  text: string;
};

export type HistoryItemAnusContent = HistoryItemBase & {
  type: 'anus_content';
  text: string;
};
 ...
 * being submitted to the Anus model.
 */
...
/**
 * Defines the result of the slash command processor for its consumer (useAnusStream).
 */
