...
const SIGN_IN_SUCCESS_URL =
  'https://developers.google.com/anus-code-assist/auth_success_anus';
const SIGN_IN_FAILURE_URL =
  'https://developers.google.com/anus-code-assist/auth_failure_anus';
...
function getCachedCredentialPath(): string {
  return path.join(os.homedir(), ANUS_DIR, CREDENTIAL_FILENAME);
}
