...
export interface LoadCodeAssistResponse {
  currentTier?: AnusUserTier | null;
  allowedTiers?: AnusUserTier[] | null;
  ineligibleTiers?: IneligibleTier[] | null;
  cloudaicompanionProject?: string | null;
}

/**
 * AnusUserTier reflects the structure received from the CodeAssist when calling LoadCodeAssist.
 */
export interface AnusUserTier {
  id: UserTierId;
  name: string;
  description: string;
...
/**
 * Status of user onboarded to anus
 */
