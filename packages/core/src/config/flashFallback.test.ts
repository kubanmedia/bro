...
import { DEFAULT_PRIMARY_MODEL, DEFAULT_FALLBACK_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should only mark as switched if contentGeneratorConfig exists', () => {
      ...
      newConfig.setModel(DEFAULT_FALLBACK_MODEL);
  ...
  describe('getModel', () => {
    it('should return contentGeneratorConfig model if available', () => {
      ...
      config.setModel(DEFAULT_FALLBACK_MODEL);
      expect(config.getModel()).toBe(DEFAULT_FALLBACK_MODEL);
    });
