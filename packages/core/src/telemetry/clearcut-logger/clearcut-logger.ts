...
export interface EventValue {
  anus_cli_key: EventMetadataKey;
  value: string;
}

export interface LogEvent {
  console_type: 'ANUS_CLI';
  application: number;
  event_name: string;
 ...
 * distribution channel in which the user is using ANUS.  ANUS comes bundled
...
export class ClearcutLogger {
  ...
  logStartSessionEvent(event: StartSessionEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_MODEL,
        value: event.model,
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_SESSION_ID,
        value: this.config?.getSessionId() ?? '',
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_EMBEDDING_MODEL,
        value: event.embedding_model,
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_SANDBOX,
        value: event.sandbox_enabled.toString(),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_CORE_TOOLS,
        value: event.core_tools_enabled,
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_APPROVAL_MODE,
        value: event.approval_mode,
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_API_KEY_ENABLED,
        value: event.api_key_enabled.toString(),
      },
      {
        anus_cli_key:
          EventMetadataKey.ANUS_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        anus_cli_key:
          EventMetadataKey.ANUS_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_MCP_SERVERS,
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_START_SESSION_TELEMETRY_ENABLED,
        value: event.telemetry_enabled.toString(),
      },
      {
        anus_cli_key:
          EventMetadataKey.ANUS_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
        value: event.telemetry_log_user_prompts_enabled.toString(),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_VERSION,
        value: CLI_VERSION,
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_GIT_COMMIT_HASH,
  ...
  logNewPromptEvent(event: UserPromptEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_USER_PROMPT_LENGTH,
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_PROMPT_ID,
        value: JSON.stringify(event.prompt_id),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_AUTH_TYPE,
  ...
  logToolCallEvent(event: ToolCallEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_TOOL_CALL_NAME,
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_TOOL_CALL_DECISION,
        value: JSON.stringify(event.decision),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_TOOL_CALL_SUCCESS,
        value: JSON.stringify(event.success),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_TOOL_CALL_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_TOOL_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_TOOL_CALL_ERROR_TYPE,
    ...
    if (event.metadata) {
      const metadataMapping: { [key: string]: EventMetadataKey } = {
        ai_added_lines: EventMetadataKey.ANUS_CLI_AI_ADDED_LINES,
        ai_removed_lines: EventMetadataKey.ANUS_CLI_AI_REMOVED_LINES,
        user_added_lines: EventMetadataKey.ANUS_CLI_USER_ADDED_LINES,
        user_removed_lines: EventMetadataKey.ANUS_CLI_USER_REMOVED_LINES,
      };

      for (const [key, anus_cli_key] of Object.entries(metadataMapping)) {
  ...
  logApiRequestEvent(event: ApiRequestEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_REQUEST_MODEL,
  ...
  logApiResponseEvent(event: ApiResponseEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_PROMPT_ID,
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_ERROR_MESSAGE,
        value: JSON.stringify(event.error),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_INPUT_TOKEN_COUNT,
        value: JSON.stringify(event.input_token_count),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT,
        value: JSON.stringify(event.output_token_count),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_CACHED_TOKEN_COUNT,
        value: JSON.stringify(event.cached_content_token_count),
      },
      {
        anus_cli_key:
          EventMetadataKey.ANUS_CLI_API_RESPONSE_THINKING_TOKEN_COUNT,
        value: JSON.stringify(event.thoughts_token_count),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_RESPONSE_TOOL_TOKEN_COUNT,
  ...
  logApiErrorEvent(event: ApiErrorEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_ERROR_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_PROMPT_ID,
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_ERROR_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_API_ERROR_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_AUTH_TYPE,
  ...
  logChatCompressionEvent(event: ChatCompressionEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_COMPRESSION_TOKENS_BEFORE,
        value: `${event.tokens_before}`,
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_COMPRESSION_TOKENS_AFTER,
  ...
  logLoopDetectedEvent(event: LoopDetectedEvent): void {
    const data: EventValue[] = [
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_LOOP_DETECTED_TYPE,
  ...
  logNextSpeakerCheck(event: NextSpeakerCheckEvent): void {
    const data: EventValue[] = [
      ...
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_RESPONSE_FINISH_REASON,
        value: JSON.stringify(event.finish_reason),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_NEXT_SPEAKER_CHECK_RESULT,
  ...
  logSlashCommandEvent(event: SlashCommandEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_SLASH_COMMAND_NAME,
    ...
    if (event.subcommand) {
      data.push({
        anus_cli_key: EventMetadataKey.ANUS_CLI_SLASH_COMMAND_SUBCOMMAND,
    ...
    if (event.status) {
      data.push({
        anus_cli_key: EventMetadataKey.ANUS_CLI_SLASH_COMMAND_STATUS,
  ...
  logMalformedJsonResponseEvent(event: MalformedJsonResponseEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_MALFORMED_JSON_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
    ];
  ...
  logIdeConnectionEvent(event: IdeConnectionEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_IDE_CONNECTION_TYPE,
  ...
  logKittySequenceOverflowEvent(event: KittySequenceOverflowEvent): void {
    const data: EventValue[] = [
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_KITTY_SEQUENCE_LENGTH,
        value: event.sequence_length.toString(),
      },
      {
        anus_cli_key: EventMetadataKey.ANUS_CLI_KITTY_TRUNCATED_SEQUENCE,
...
function addDefaultFields(data: EventValue[]): EventValue[] {
  ...
  const defaultLogMetadata: EventValue[] = [
    {
      anus_cli_key: EventMetadataKey.ANUS_CLI_GOOGLE_ACCOUNTS_COUNT,
      value: `${totalAccounts}`,
    },
    {
      anus_cli_key: EventMetadataKey.ANUS_CLI_SURFACE,
      value: surface,
    },
  ];
