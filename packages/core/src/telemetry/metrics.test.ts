...
describe('Telemetry Metrics', () => {
  ...
  describe('recordTokenUsageMetrics', () => {
    ...
    it('should not record metrics if not initialized', () => {
      recordTokenUsageMetricsModule(mockConfig, 'grok-beta', 100, 'input');
      expect(mockCounterAddFn).not.toHaveBeenCalled();
    });
    ...
    it('should record token usage for different types', () => {
      ...
      recordTokenUsageMetricsModule(mockConfig, 'grok-beta', 50, 'output');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'grok-beta', 25, 'thought');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'grok-beta', 75, 'cache');
      ...
      recordTokenUsageMetricsModule(mockConfig, 'grok-beta', 125, 'tool');
    ...
    it('should handle different models', () => {
      ...
      recordTokenUsageMetricsModule(mockConfig, 'anus-ultra', 200, 'input');
