    ...
    try {
      ...
      const fileFilteringOptions = {
        ...
        respectAnusIgnore:
          ...
          defaultFileIgnores.respectAnusIgnore,
      };
      ...
      for (const file of files) {
        ...
        // Check if this file should be ignored based on git or anus ignore rules
        if (
        ...
        if (
          ...
          fileDiscovery.shouldAnusIgnoreFile(relativePath)
        ) {
          anusIgnoredCount++;
          continue;
        }
      ...
      if (anusIgnoredCount > 0) {
        ignoredMessages.push(`${anusIgnoredCount} anus-ignored`);
      }
    ...
    super(
      ...
      Kind.Search,
      {
        properties: {
          ...
          file_filtering_options: {
            description:
              'Optional: Whether to respect ignore patterns from .gitignore or .anusignore',
            type: 'object',
            properties: {
              respect_git_ignore: {
                description:
