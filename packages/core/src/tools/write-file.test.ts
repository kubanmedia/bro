...
const rootDir = path.resolve(os.tmpdir(), 'anus-cli-test-root');
...
const mockConfigInternal = {
  ...
  getAnusClient: vi.fn(), // Initialize as a plain mock function
  getIdeClient: vi.fn(),
...
describe('WriteFileTool', () => {
  ...
  beforeEach(() => {
    ...
    // Setup AnusClient mock
    mockAnusClientInstance = new (vi.mocked(AnusClient))(
      mockConfig,
    ) as Mocked<AnusClient>;
    vi.mocked(AnusClient).mockImplementation(() => mockAnusClientInstance);
    ...
    // Now that mockAnusClientInstance is initialized, set the mock implementation for getAnusClient
    mockConfigInternal.getAnusClient.mockReturnValue(mockAnusClientInstance);
